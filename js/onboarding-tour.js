...
(function () {
  ...
  var POLICIES_URL = '/strategies-and-policies?from=account';
  ...
  var steps = [
    ...
    // Step 1/5: Верхня панель
    {
      step: '1/5',
      title: '1/5 Верхня панель',
      text: 'Швидкий доступ до скарг, пропозицій, анкетування та профілю.',
      selector: '.softr-topbar',
      position: 'bottom',
      button: 'Далі'
    },
    // Step 2/5: Ваш профіль
    {
      step: '2/5',
      title: '2/5 Ваш профіль',
    ...
    // Step 3/5: Ваш особистий профіль (merged old 3+4)
    {
      step: '3/5',
      title: '3/5 Ваш особистий профіль',
    ...
    // Step 5/5: Головне меню
    {
      step: '5/5',
      title: '5/5 Головне меню',
      html: true,
