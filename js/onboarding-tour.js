...
(function () {
  ...
  var steps = [
    ...
    // Step 1/7: Верхня панель
    {
      step: '1/7',
      title: '1/7 Верхня панель',
      text: 'Швидкий доступ до скарг, пропозицій та перемикання між основними функціями.',
      selector: '.softr-topbar',
      position: 'bottom',
      button: 'Далі'
    },
    // Step 2/7: Ваш профіль
    {
      step: '2/7',
      title: '2/7 Ваш профіль',
      text: 'Тут можна змінити мову інтерфейсу або вийти з системи.',
    ...
    // Step 3/7: Ваш особистий профіль
    {
      ...
      text: 'Тут зібрана вся основна інформація про Вас як волонтера фонду.',
      selector: '.b-1c25cc8',
      position: 'right',
      button: 'Далі'
    },
    // Step 4/7: Налаштування особистого профілю
    {
      ...
      text: 'Будь ласка, перевірте свою особисту інформацію в профілі та додайте дані, яких не вистачає. Якщо якась інформація змінилася — також оновіть її. Це важливо для коректної співпраці.',
      selector: 'main form',
      position: 'right',
      button: 'Далі'
    },
    ...
    // Step 7/7: Виникли питання?
    {
      step: '7/7',
      title: '7/7 Виникли питання?',
      text: 'Будь ласка, перевірте свою особисту інформацію в профілі та додайте дані, яких не вистачає. Якщо якась інформація змінилася — також оновіть її.',
      selector: null,
      position: 'center',
      button: 'Далі'
    },
    // Final Step: Огляд завершено!
    {
      ...
      text: 'Тепер Ви готові до роботи з порталом.<br><br>' +
        ...
        'Після перегляду необхідно підтвердити ознайомлення, натиснувши відповідну кнопку.',
      selector: null,
      position: 'center',
