...
(function () {
  ...
  var steps = [
    // Step 0: Welcome Introduction (centered modal, no spotlight)
    {
      ...
      text: 'Зараз ми коротко ознайомимо Вас з порталом фонду. Це наш спільний робочий простір: тут зібрані важливі документи, правила взаємодії, структура роботи та матеріали, які допоможуть швидко зорієнтуватися і компетентно включитися в процеси.',
      selector: null,
      position: 'center',
      button: 'Почати огляд'
    },
    // Step 1/7: Верхня панель навігації
    {
      step: '1/7',
      title: '1/7 Верхня панель',
      text: 'Швидкий доступ до скарг, пропозицій та переміщення між основними функціями порталу.',
    ...
    // Step 3/7: Ваш особистий профіль
    {
      ...
      text: 'Тут зібрана вся основна інформація про Вас як волонтера фонду — email, пароль та ім\'я.',
      selector: '.b-1c25cc8',
      position: 'right',
      button: 'Далі'
    },
    // Step 4/7: Налаштування особистого профілю
    {
      ...
      text: 'Будь ласка, перевірте свою особисту інформацію в профілі та додайте дані, яких не вистачає. Якщо якась інформація змінилась — також оновіть її. Це важливо для коректної співпраці.',
      selector: 'main form',
      position: 'right',
      button: 'Далі'
    },
    // Step 5/7: Головне меню
    {
      step: '5/7',
      title: '5/7 Головне меню',
      html: true,
      text: 'Зліва на порталі розташовані основні розділи:<ul>' +
        '<li><strong>Портал фонду</strong> — головна сторінка з важливою інформацією та оновленнями.</li>' +
        '<li><strong>Завдання</strong> — ваші особисті завдання та задачі для вашого відділу.</li>' +
        '<li><strong>Структура фонду</strong> — організаційна структура: відділи, керівництво та потоки ініціатив.</li>' +
        '<li><strong>Політики та стратегії</strong> — обов\'язковий розділ для ознайомлення. Після перегляду необхідно підтвердити ознайомлення.</li>' +
        '</ul>',
      selector: '.softr-sidebar',
      position: 'right',
      button: 'Далі'
    },
    // Step 6/7: Основний контент
    {
      step: '6/7',
      title: '6/7 Робоча область',
      text: 'Це основна робоча область порталу. Тут відображається вміст обраного розділу — налаштування профілю, завдання, документи тощо.',
      selector: 'main',
      position: 'left',
      button: 'Далі'
    },
    // Step 7/7: Перевірте дані
    {
      step: '7/7',
      title: '7/7 Перевірте свої дані',
      text: 'Будь ласка, перевірте свою особисту інформацію в профілі та додайте дані, яких не вистачає. Якщо якась інформація змінилась — також оновіть її.',
      selector: null,
      position: 'center',
      button: 'Далі'
    },
    // Final Step: Огляд завершено!
    {
      ...
      html: true,
      text: 'Тепер Ви готові до роботи на порталі.<br><br>' +
        'Будь ласка, перейдіть до обов\'язкового розділу «Політики та стратегії» для ознайомлення з внутрішніми правилами фонду. ' +
        'Після ознайомлення необхідно підтвердити це, натиснувши відповідну кнопку.',
      selector: null,
      position: 'center',
      button: 'Готово'
    }
